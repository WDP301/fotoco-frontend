...
export default function CreateGroupForm({
  ...
  const handleCreateGroup = async (values: z.infer<ReturnType<typeof getCreateGroupSchema>>) => {
    setIsLoading(true);
          ...
          <div className="grid gap-4 py-4">
                ...
                <div className="grid w-full gap-1.5">
                  <FormItem>
                    <FormLabel className="text-primary">
                      <Label htmlFor="description">{dict.createGroup.description}</Label>
                    </FormLabel>
                    <FormControl>
                      <Textarea
                      id="description"
            ...
            <FormField
              ...
              render={({ field }) => {
                ...
                return (
                  <FormItem>
                    <FormLabel className="text-primary">{dict.createGroup.type}</FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="PUBLIC">{dict.createGroup.public}</SelectItem>
                        <SelectItem value="PRIVATE">{dict.createGroup.private}</SelectItem>
                        <SelectItem value="HIDDEN">
                          <div className="flex items-center justify-between">
                            <span>{dict.createGroup.hidden}</span>
                            {/* <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>{dict.createGroup.tooltipContent}</p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider> */}
                          </div>
