  ...
  return (
    <div className="flex border rounded-lg items-center text-sm px-1">
      <input
        ...
        className="p-0 outline-none w-6 border-none text-center bg-card"
        placeholder="M"
      />
      ...
      <input
        ...
        className="p-0 outline-none w-7 border-none text-center bg-card"
        placeholder="D"
      />
      <span className="opacity-20 -mx-px">/</span>
      <input
        ...
        className="p-0 outline-none w-12 border-none text-center bg-card"
        placeholder="YYYY"
      />
    </div>
  );
